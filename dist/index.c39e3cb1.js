...
})({"1ZsWO":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
...
tabsContainer.addEventListener('click', function (e) {
  const clicked = e.target.closest('.operations__tab'); // Guard clause

  if (!clicked) return; // Remove active classes

  tabs.forEach(t => t.classList.remove('operations__tab--active'));
  tabsContent.forEach(c => c.classList.remove('operations__content--active')); // Activate tab
...
*/
},{}]},{},["1ZsWO","28muQ"], "28muQ", "parcelRequired6ff")

//# sourceMappingURL=index.c39e3cb1.js.map
